...
yeartobeold = year + agedifference
print("Hello, {}! You will be hundred years old in the year {}".format(name, yeartobeold))

#Extras
msg = "Hello, " + name + "! You will be 100 years old in the year " + str(yeartobeold)
